...
import CircularProgressBar from '../../components/circularProgressBar/circularProgressBar'; // Import the new component
import './home.css';
...
const Home = () => {
  ...
  const toggleWatchlist = (movie) => {
    if (watchlist.some(watchlistedMovie => watchlistedMovie.id === movie.id)) {
      ...
      setWatchlist(watchlist.filter(watchlistedMovie => watchlistedMovie.id !== movie.id));
    } else {
      // Add to watchlist
